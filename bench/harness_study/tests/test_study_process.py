    ...
    def test_symbolic_policy_metrics_count_derived_decisions_and_model_purposes(self):
        ...
        final_task = {"id": "one", "phase": "Complete", "schema": 2,
                      ...
                      "intent_events": [
                          ...
                          {"id": "n", "cycle": None, "kind": "guidance_loaded", "detail": "default, 639 bytes, sha256 ab"},
                          {"id": "o", "cycle": None, "kind": "constraint_coverage", "detail": "{\"covered\": false}"},
                          {"id": "p", "cycle": None, "kind": "constraint_coverage", "detail": "{\"covered\": true}"},
        ...
        expected = {"obligations_derived": 1, "obligations_unresolved": 0, "scope_escape_replan": 1,
                    ...
                    "constraint_coverage_unmet": 1, "edit_grounding": 1,
